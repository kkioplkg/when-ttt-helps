...
if _here.parent.name == "tools" and _here.parents[1].name == "is2":
    # paper/is2/tools/r9_reconcile.py -> repository root
...
M0DIR = REPO / "experiments" / "results" / "m0"
...
_PROV_STAGING_TREE = REPO / "experiments" / "results" / "is_fresh_incoming_gpu"
...
con("the two implementations of the selector both document the tolerance "
    "they apply",
    ((REPO / "experiments" / "ttt" / "core" / "alta.py")
     .read_text(encoding="utf-8")
     + (REPO / "experiments" / "ttt" / "is_fresh"
