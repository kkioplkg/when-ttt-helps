...
VECDIR = os.path.join(REPO, "experiments", "results", "is_fresh", "e3_vectors")
RETDIR = os.path.join(REPO, "experiments", "results", "e4")
OUT = os.path.join(REPO, "experiments", "results", "is_fresh",
