...
REPO = os.path.dirname(os.path.dirname(_TTT))
...
DATA_ROOT = os.path.join(REPO, "experiments", "data")
OUT_DIR = os.path.join(REPO, "experiments", "results", "is_fresh", "e2_gn")
SEED = 20260806
ARCH = "resnet26ttt"
DATASET = "cifar10"
...
def published_source_reference():
    ...
    ref = []
    for s in (0, 1, 2):
        p = os.path.join(REPO, "experiments", "results", "m0",
